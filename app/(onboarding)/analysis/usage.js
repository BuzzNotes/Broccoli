      ...
      <Animated.View style={[
        ...
        <View style={styles.centerContent}>
          ...
          <Text style={styles.message}>
            Your cannabis usage pattern will help us determine the best recovery timeline and milestones for you. More frequent use typically means a longer recovery period, but don't worry - we'll help you through every step.
          </Text>
        </View>
